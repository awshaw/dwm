...
static const char *fonts[]          = { "noto-fonts-sans-display:size=10" };
static const char dmenufont[]       = "monospace:size=10";
// background color
static const char col_gray1[]       = "#300001";
// inactive window border color
static const char col_gray2[]       = "#300001";
// font color
static const char col_gray3[]       = "#FFFFFF";
// current tag and current window font color
static const char col_gray4[]       = "#D9181B";
// top bar second color and active window border color
static const char col_cyan[]        = "#300001";
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_x, 	   spawn,          SHCMD("~/.config/keymaps/shudderdown") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
